...
namespace Assets.Game.StartArcheticture.UI {
    public sealed class WindowShowHideAnimation {
        ...
        public Sequence GetShowSequence(StartAnimType startAnimType, CanvasGroup canvasGroup, RectTransform cachedTransform) {
            switch (startAnimType) {
                case StartAnimType.ScaleUp:
                    return GetShowSequenceScaled(canvasGroup, cachedTransform);
                case StartAnimType.FromDown:
                    return GetShowSequenceFrom(Vector2.down, canvasGroup, cachedTransform);
                case StartAnimType.FromTop:
                    return GetShowSequenceFrom(Vector2.up, canvasGroup, cachedTransform);
                case StartAnimType.FromLeft:
                    return GetShowSequenceFrom(Vector2.left, canvasGroup, cachedTransform);
                case StartAnimType.FromRight:
                    return GetShowSequenceFrom(Vector2.right, canvasGroup, cachedTransform);
                case StartAnimType.RotateScaleUp:
                    return GetShowSequenceRotateScaled(cachedTransform);
                case StartAnimType.EventStartShow:
                    return GetShowSequenceEventStartShow(canvasGroup, cachedTransform);
                case StartAnimType.FadeUp:
                    return GetShowSequenceFadeShow(canvasGroup);
                case StartAnimType.NoAnim:
                    return GetShowSequenceNoAnim(canvasGroup);
                default:
        ...
        public Sequence GetHideSequence(EndAnimType endAnimType, CanvasGroup canvasGroup, RectTransform cachedTransform) {
            switch (endAnimType) {
                case EndAnimType.ScaleDown:
                    return GetHideSequenceScaled(cachedTransform);
                case EndAnimType.ToDown:
                    return GetHideSequenceTo(Vector2.down, canvasGroup, cachedTransform);
                case EndAnimType.ToTop:
                    return GetHideSequenceTo(Vector2.up, canvasGroup, cachedTransform);
                case EndAnimType.ToLeft:
                    return GetHideSequenceTo(Vector2.left, canvasGroup, cachedTransform);
                case EndAnimType.ToRight:
                    return GetHideSequenceTo(Vector2.right, canvasGroup, cachedTransform);
                case EndAnimType.FadeDown:
                    return GetHideSequenceFadeHide(canvasGroup);
                default:
                    return TweenHelper.CreateSequence(this);
            }
        }
        ...
        public float GetShowCallbackTime(StartAnimType startAnimType) {
            switch (startAnimType) {
                ...
                case StartAnimType.ScaleUp:
                    return ShowFadeTime;
                case StartAnimType.FromTop:
                    return ShowMoveTime / 2;
                case StartAnimType.RotateScaleUp:
                    return ShowRotateTime;
                default:
                    return ShowMoveTime;
            }
        }
